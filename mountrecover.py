...
def ILRMain(ilr_params):
    ...
    if IsMultiTarget == "0":
        ...
        is_blocked_list = filter(lambda x: "blocked" in x.lower(), output_lines)
...
if __name__ == "__main__":
    if os.getuid() != 0:
    	...
    	VMName="iaasvmcontainerv2;oim-appservices;az-monitor-001"
    	MachineName="az-monitor-001"
    	TargetPortalAddress="pod01-rec2.ae.backup.windowsazure.com"
    	TargetPortalPortNumber="3260"
    	TargetNodeAddress="iqn.2016-01.microsoft.azure.backup:9021753158828370542-276832-87961878014594-45646971362997.637336610840882084"
    	InitiatorChapPassword="7eeae40c9dba3b"
    	ScriptId="d199a302-5d38-44dd-96f8-bd17aa0d1663"
    	TargetUserName="9021753158828370542-bfea810d-5aae-47ed-b07c-0b648796ff76"
